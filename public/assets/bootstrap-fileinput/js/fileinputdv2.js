    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tMain1 = '{preview}\n' +
                ...
                '      {cancel}\n' +
                '      <button class="btn btn-danger remove-file-uploaded" style="display: none"><i class="fas fa-trash"></i>Eliminar archivo</button>\n' +
                '      {browse}\n' +
                '    </div>\n' +
                '</div>';
            ...
            tCaption = '<div class="file-caption form-control {class}" tabindex="500">\n' +
                ...
                '  <input class="file-caption-name" disabled onkeydown="return false;" onpaste="return false;">\n' +
                '</div>';
            //noinspection HtmlUnknownAttribute
            ...
            tImage = '<img src="{data}" class="file-preview-image kv-preview-data img-fluid img-thumbnail" title="{caption}" ' +
                'alt="{caption}">\n';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: true,
                    showDrag: true,
                    removeIcon: '<i class="fas fa-trash mr-2"></i>',
                    removeClass: 'btn btn-sm btn-kv btn-default btn-outline-danger',
...
/*                xhr: function () {
            ...
            self.ajaxRequests.push(axios(settings));
        },
    ...
    $.fn.fileinput.defaults = {
        ...
        removeIcon: '<i class="fa fa-trash mr-2"></i>',
        removeClass: 'btn btn-default btn-outline-danger',
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgPlaceholder: 'Selecciona el archivo',
        msgZoomModalHeading: 'Vista Previa ',
        msgFileRequired: 'Debes de seleccionar un archivo para subir.',
        ...
        previewZoomButtonTitles: {
            ...
            toggleheader: 'Ocultar o mostrar encabezado',
            fullscreen: 'Pantalla completa',
            borderless: 'Alternar en modo sin bordes',
