...
var jsc = {
	...
	pub : function (targetElement, opts) {
		...
		this.previewPosition = 'right'; // 'left' | 'right' - position of the color preview in previewElement
		this.previewSize = 50; // (px) width of the color preview displayed in previewElement
