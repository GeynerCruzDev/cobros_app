...
<head>
    ...
    <link rel = "stylesheet" type = "text/css" href = "{{ asset('assets/animatecss/animate.css') }}" />
    <link rel = "stylesheet" type = "text/css" href = "{{ asset('assets/nprogress/nprogress.css') }}" />
    @yield('crsf_token')
</head>
...
<nav  class="topnav navbar fixed-top navbar-expand shadow justify-content-between justify-content-sm-start navbar-light" style="background-color: #2e4999" id="sidenavAccordion">
    ...
    <ul class="navbar-nav align-items-center ml-auto order-2 order-lg-3">
        ...
        <li class="nav-item dropdown no-caret d-none d-sm-block mr-3 dropdown-notifications">
            <a class="btn btn-icon btn-transparent-light dropdown-toggle" id="navbarDropdownAlerts" href="{{ route('notificaciones') }}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i data-feather="bell"></i></a>
...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main>
            @yield('main_content')
            <div id = "mensaje-block-ui" style = "display: none;">
                    ...
                    <div class = "form-group text-center">
                        <center >
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="mt-4">
                                    <h3 class="text-white">Cargando, por favor espere.</h3>
                                </div>
                            </div>
                            <!--<div class="lds-ring"><div></div><div></div><div></div><div></div></div>
                            <label for="" class="text-white">Cargando, por favor espere.</label>-->
                        </center>
                    </div>
                </div>
            </div>
